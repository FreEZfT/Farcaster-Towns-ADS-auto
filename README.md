...
Что умеет софт: 
Farcaster: скроллинг ленты, лайки, комменты, репосты, создание рандомного поста с использованием подготовленных тексов и картинок, подписка на других пользователей
